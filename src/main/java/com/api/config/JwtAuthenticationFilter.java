...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            handleException(response, HttpStatus.UNAUTHORIZED, "Session Expired");

        } catch (ServletException | IOException | UsernameNotFoundException e) {
            handleException(response, HttpStatus.INTERNAL_SERVER_ERROR, "Authentification Internal Server Error");
            throw e;
